...
- `readRDS("~/203b-hw/hw4/mimiciv_shiny/mimic_icu_cohort.rds")` does not work on others as instructed in his lecture and slack many times. `-10.0`
...
- Great data pre-processing. `+5.0`

- XGBoost (as well as logistic regression) can provide variable importance measures similar to those from random forests. `-5.0`

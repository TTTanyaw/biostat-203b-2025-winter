...
```{r}
# Define file path
file_path <- "/home/tttanyaw/mimic/hosp/admissions.csv.gz"

# Read using base R
system.time(df_base <- read.csv(file_path))

# Read using tidyverse
system.time(df_tidy <- read_csv(file_path))

# Read using data.table
system.time(df_dt <- fread(file_path))
```
...
# Run time
system.time(df_tidy_appro <- read_csv(file_path, col_types = appro_data_type))

...
Q1.8 summaries should roughly match those given.
  ...
  - As I also pointed out to your classmate, this discrepancy is due to having 94,364 rows in Q1.6 because of missing `stay_id`'s, as I mentioned on Slack on 2/23 at 11:20 PM. You should have added `stay_id` in Lines 156 and 160. `-2.0`  

- Q2 (95/100)

    - 1st tab: Numerical summaries for `gender`, `insurance`, `marital_status` do not work well. are not working properly. Should display n (%) for each level, similar to race.`-5.0`
